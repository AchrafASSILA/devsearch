...
if (isset($_SESSION["username"])) {
    ...
    $id = $_SESSION["id"];
    $skill_id = $_GET["id"];
    $skill = getSkill($db, $username, $skill_id);
    if (isset($_POST["submit"])) {
        ...
        updateSkill($db, $username, $skill_id, $id, $skill_name, $skill_desc);
            ...
            <div class="formWrapper">
                ...
                <form class="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form__field">
                        ...
                        <input class="input input--text" id="skill_name" value="<?php echo $skill->name ?>" type="text" name="skill_name" placeholder="Enter skill name" />
                    </div>
                    <div class="form__field">
                        <label for="skill_desc">Skill description: </label>
                        <textarea class="input input--text" id="skill_desc" type="text" name="skill_desc" placeholder="Enter skill description"><?php echo $skill->description ?></textarea>
                    ...
                    <?php } ?>
                    <input class="btn btn--sub btn--lg  my-md" type="submit" name="submit" value="Update Skill" />
                </form>
            </div>
        </div>
    </main>
